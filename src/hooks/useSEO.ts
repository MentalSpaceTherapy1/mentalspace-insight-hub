...
export const SEO_CONFIGS = {
  home: {
    title: "Coping and Healing Counseling - Online Therapy & Mental Health Services | Licensed Therapists Available 24/7",
    ...
    ogTitle: "Coping and Healing Counseling - Professional Online Therapy Services",
  ...
  onlineTherapy: {
    title: "Online Therapy Services - Licensed Therapists | Coping and Healing Counseling",
  ...
  couplesTherapy: {
    title: "Couples Therapy & Relationship Counseling Online | Coping and Healing Counseling",
  ...
  teenTherapy: {
    title: "Teen Therapy & Adolescent Counseling Services | Coping and Healing Counseling",
  ...
  lifeCoaching: {
    title: "Life Coaching Services Online - Personal Development | Coping and Healing Counseling",
