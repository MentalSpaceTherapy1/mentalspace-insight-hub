        ...
        <nav className="hidden md:flex items-center space-x-1">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-64 bg-card/95 backdrop-blur-xl border border-border/50 shadow-2xl rounded-xl p-2 animate-fade-in">
              ...
              <DropdownMenuItem asChild>
                <Link to="/online-therapy-georgia" className="relative w-full cursor-pointer rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-gradient-to-r hover:from-primary/10 hover:to-primary/5 transition-all duration-200">
                  <div className="flex items-center space-x-3">
                    <Sparkles className="h-4 w-4 text-primary" />
                    <span>Georgia Therapy Hub</span>
                  </div>
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
