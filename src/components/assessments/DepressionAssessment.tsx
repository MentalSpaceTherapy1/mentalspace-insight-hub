...
const DepressionAssessment = ({ onBack }: { onBack: () => void }) => {
  ...
  const handleNext = () => {
    if (currentQuestion < questions.length - 1) {
      ...
      alert(`Assessment complete! Your PHQ-9 score is ${totalScore}. This is for informational purposes only - please consult a healthcare professional for proper evaluation.`);
    }
  };
